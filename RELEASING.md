...
|---|---:|---|
| Cursor Bridge | 5.10.0 | Codex, Claude Code, Grok Build |
| Grok Build Supervisor | 0.4.1 | Codex, Claude Code |
| Cursor Bridge for Pi | 0.1.16 | `pi-cursor-bridge` on npm |
...
- `pi-cursor-bridge`: package and adapter 0.1.16, embedded Cursor Bridge 5.10.0
...
```powershell
git tag -a cursor-bridge--v5.10.0 -m "Cursor Bridge 5.10.0"
git push origin refs/tags/cursor-bridge--v5.10.0
```
...
```text
Cursor Bridge 5.10.0 (New) + Grok Build Supervisor 0.4.1
```
