...
|---|---:|---|
| Cursor Bridge | 6.0.0 | Codex, Claude Code, Grok Build |
| Grok Build Supervisor | 0.4.1 | Codex, Claude Code |
| Cursor Bridge for Pi | 0.2.0 | `pi-cursor-bridge` on npm |
...
- `pi-cursor-bridge`: package and adapter 0.2.0, embedded Cursor Bridge 6.0.0
...
```powershell
git tag -a cursor-bridge--v6.0.0 -m "Cursor Bridge 6.0.0"
git push origin refs/tags/cursor-bridge--v6.0.0
```
...
```text
Cursor Bridge 6.0.0 (New) + Grok Build Supervisor 0.4.1
```
