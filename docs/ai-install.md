...
npm install --prefix $prefix vanyangyang-cursor-bridge@0.1.4
```
...
Record `source: npm:vanyangyang-cursor-bridge@0.1.4`.
...
- source: npm:vanyangyang-cursor-bridge@0.1.4 | git-checkout | repo-workspace
