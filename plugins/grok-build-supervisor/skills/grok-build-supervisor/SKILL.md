...
- The initialized proxy endpoint is stored in the user-level Supervisor state root, outside plugin caches. It survives host restarts and plugin reinstalls; rerun `/grok_init` when the local proxy port changes.
