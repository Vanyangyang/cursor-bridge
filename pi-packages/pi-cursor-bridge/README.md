...
This Pi package embeds Cursor Bridge 5.5.0. Cursor must be installed and signed in. Current end-to-end compatibility claims remain scoped to the environments documented in the main repository.
